...
const viewBoxString = document.getElementById('viewBoxString');
...
function updateViewBox() {
  ...
  const vbString = `0 0 ${w} ${h}`;
  demoSVG.setAttribute('viewBox', vbString);
  viewBoxString.textContent = vbString;
...
function copyViewBox() {
  const text = viewBoxString.textContent;
...
copyBtn.addEventListener('click', copyViewBox);
