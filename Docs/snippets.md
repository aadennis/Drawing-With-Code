## SVG: Snippets in VSCode

You can't remember them all the syntax. Well, I can't. Here is a list for plugging into VSCode. The unimaginative '...full' at the end of each prefix is to prevent conflict with the SVG reserved words. 
